# Generated by Django 2.2.5 on 2019-10-16 08:12
import uuid
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    model_history.fields.RevisionedForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="testapp.Bar"
                    ),
                ),
            ],
            options={"abstract": False},
        ...
        migrations.CreateModel(
            name="BarManyBazRelationRevision",
            fields=[
                (
                    "id",
                    models.UUIDField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="children_revisions",
                        to="testapp.BarManyBazRelationRevision",
                    ),
                ),
            ],
            options={"ordering": ["revision_at"], "abstract": False},
        ...
        migrations.AddField(
            model_name="barmanybazrelation",
            name="baz",
            field=model_history.fields.RevisionedForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="testapp.Baz"
            ),
        ),
        migrations.AddField(
            model_name="bar",
        ...
        migrations.AddField(
            model_name="bar",
            name="many_baz",
            field=model_history.fields.RevisionedManyToManyField(
                through="testapp.BarManyBazRelation", to="testapp.Baz"
            ),
        ),
        migrations.AddField(
            model_name="bar",
